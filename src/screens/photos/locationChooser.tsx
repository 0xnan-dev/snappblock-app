...
import {searchLocation, MapBoxAddress} from '../../lib/utils';
import NavigationBar from '../../components/NavigationBar';
import Icon from 'react-native-vector-icons/MaterialCommunityIcons';
import {SCREEN_WIDTH} from '../../lib/constants';
import {RouteProp} from '@react-navigation/native';

type LocationChooserRouteProp = RouteProp<any, 'LocationChooser'>;
...
export default function LocationChooser({route}: LocationChooserProps) {
  const {onDone, navigation}: any = route.params;
  ...
  return (
    <SafeAreaView style={styles.container}>
      <NavigationBar title="Select a Location" callback={navigation.goBack} />
      <View
        style={{
          marginTop: 15,
        }}>
